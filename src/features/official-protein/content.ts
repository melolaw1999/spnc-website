...
export const micronizedCreatinePageContent: ProteinPageContent = {
  ...
  intro: "当前收录 300 克无味与 360 克蓝莓柠檬味两种跨境规格。选择规格后，页面会同步切换对应包装图、每份用量、配料和完整标签资料。",
  factsNote: "两款均标示每份 5 克一水肌酸、60 份；无味每份约 5 克，蓝莓柠檬味因含调味配料每份为 6 克。",
  selectorAria: "选择微粉化肌酸粉规格与口味",
  infoTitle: "了解微粉化肌酸粉",
  infoIntro: "本页按规格分别登记包装事实：300 克无味继续使用对应标签资料，360 克蓝莓柠檬味使用本次新增的完整环绕标签，不混用配料与冲调说明。",
  overviewTitle: "同为每份 5 克一水肌酸，配料与每份用量不同",
  overview: [
    "300 克无味包装标示每份约 5 克、60 份；360 克蓝莓柠檬味包装标示每份 6 克（约 1 满勺）、60 份。两款每份均提供 5 克一水肌酸。",
    "无味规格标示无其他配料；蓝莓柠檬味另含天然及人工香料、柠檬酸和三氯蔗糖。页面会随规格切换独立展示，不把两款配料混写。",
    "“微粉化”描述的是粉末颗粒处理方式。页面只陈列包装可核对的信息，不把它延伸为对每位使用者都相同的训练结果承诺。",
  ],
  benefits: [
    "两款均标示每份 5 克一水肌酸",
    "300 克无味规格",
  ...
  suggestedUseNotes: [
    "300 克无味标签建议以约 5 克作为一次用量；360 克蓝莓柠檬味标签建议将 6 克（约 1 满勺）加入冷水并混合至溶解。",
    "请使用清洁、干燥的量具，并严格按当前所选规格的实际包装说明执行。",
    "膳食补充剂不能替代均衡饮食；使用前请阅读实际包装的适用人群与注意事项。",
  ],
  nutritionTitle: "对应规格完整标签资料",
  nutritionIntro: "切换规格后，下方会同步显示对应英文标签和中文对照。300 克无味与 360 克蓝莓柠檬味的每份用量、热量和配料分别登记。",
  faqs: [
    {
      question: "300 克无味与 360 克蓝莓柠檬味有什么区别？",
      answer: "两款每份均标示 5 克一水肌酸、60 份。300 克无味每份约 5 克且标示无其他配料；360 克蓝莓柠檬味每份 6 克，另含天然及人工香料、柠檬酸和三氯蔗糖。",
    },
    {
      question: "两个规格应该怎样冲调？",
      answer: "300 克无味规格可按包装说明加入蛋白奶昔或其他饮料；360 克蓝莓柠檬味标签建议将 6 克（约 1 满勺）加入冷水并混合至溶解。具体仍以实际到货包装为准。",
    },
