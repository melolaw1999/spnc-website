...
export function Footer() {
  return <footer className="footer"><div className="container footer-grid">
    ...
    <nav className="footer-links" aria-label="页脚导航"><Link href="/lab">训复</Link><Link href="/products">商品矩阵</Link><Link href="/on">ON 专区</Link><Link href="/authenticity">防伪溯源</Link><Link href="/versions">版本说明</Link><Link href="/articles">文章</Link><Link href="/faq">售后 FAQ</Link><Link href="/support">售后登记</Link><Link href="/about">关于我们</Link><Link href="/contact">联系我们</Link><Link href="/privacy">隐私说明</Link></nav>
