...
export const metadata = pageMetadata("售后 FAQ", "理想营养售后常见问题：淘宝订单、版本差异、包装破损、退款和商品核验处理方式。", "/faq");

const questions = [
  ["在哪里购买？", "官网不提供购物车和支付。所有购买、付款、退款与订单沟通均在理想营养淘宝店完成。"],
  ...
  ["如何核验防伪信息？", "按照品牌公开方式核验，并结合购买渠道、订单、包装完整性与批次信息综合判断。不要把单一防伪码当作全部供应链证明。"],
  ["可以在官网申请退款吗？", "不可以。退款与售后需通过原淘宝订单处理，官网不收款，也不保存支付信息。"],
